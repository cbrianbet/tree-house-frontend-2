...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 flex h-11 w-11 items-center justify-center rounded-full bg-brand-100 text-sm font-semibold text-brand-600 dark:bg-brand-500/20 dark:text-brand-400">
          {initials}
        </span>
      ...
      >
        <div>
          ...
          <span className="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">
            {user.email} &middot; {roleName(user.role)}
          </span>
        </div>
